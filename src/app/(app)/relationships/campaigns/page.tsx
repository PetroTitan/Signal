...
export default async function CampaignsPage({
  ...
  if (!isSupabaseConfigured()) {
    return (
      <>
        <Topbar
          title="Follow campaigns"
          description="Queue profiles and follow them on a daily schedule."
        />
        <div className="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 max-w-4xl">
          <div className="card card-padded">
            <p className="text-sm text-ink-600">
              Connect Supabase to manage follow campaigns.
            </p>
          </div>
        </div>
      </>
  ...
  if (!membership) {
    return (
      <>
        <Topbar title="Follow campaigns" description="Queue profiles and follow them." />
        <div className="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 max-w-4xl">
          <div className="card card-padded">
  ...
  return (
    <>
      <Topbar
        title="Follow campaigns"
        description="Queue profiles and follow them on a daily schedule you approve. Nothing unfollows anyone."
      />
